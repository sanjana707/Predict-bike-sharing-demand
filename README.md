...
## Overview
In this project, I have applied the knowledge and methods they learned in the Introduction to Machine Learning course to compete in a Kaggle competition using the AutoGluon library.

Following were the prerequisite for the project:
